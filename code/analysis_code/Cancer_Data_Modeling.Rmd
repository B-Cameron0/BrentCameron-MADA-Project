...
data_split <- initial_split(cancer_data_cleaned, prop = 7/10,#7/10 stands for 70% training
                strata = "Deaths") # and the rest (30%) for testing) 
```
...
FoldCV5 <- vfold_cv(train_data, v = 5, repeats = 5, strata = "Deaths")
...
#We will now create our wokflow
```{r}
