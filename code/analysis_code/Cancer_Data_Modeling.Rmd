...
```
Our LASSO model has a mean value of 22121.36, which is lower than the null model of 23678, but higher than our single tree model value of 20315. We will finally utilize the RandomForest model to check for quality of fit for our model.


# RANDOMFOREST
So far our single tree model has performed best, we will evaluate the random forest model lat
