...
```{r distribution,  fig.cap='\\label{fig::distribution}Cancer Deaths by Age Group', echo=FALSE}
knitr::include_graphics("../../results/Cancer_Deaths_by_Age_Group.png")
```


```{r distribution,  fig.cap='\\label{fig::distribution}Cancer Deaths by Race', echo=FALSE}
knitr::include_graphics("../../results/Cancer_Deaths_By_Race.png")
```


```{r distribution,  fig.cap='\\label{fig::distribution}Cancer Deaths by Site', echo=FALSE}
knitr::include_graphics("../../results/Cancer_Deaths_by_Site.png")
```

```{r distribution,  fig.cap='\\label{fig::distribution}Cancer Deaths by Sex', echo=FALSE}
